...
public class DependencyComposite extends AbstractTableComposite<ISymbiot> {
	...
	public DependencyComposite(Composite parent, int style) {
	...
	private class SymbiotLabelProvider extends LabelProvider implements ITableLabelProvider{
		...
		public String getColumnText( Object element, int columnIndex ) {
			...
			default:
				...
				if( data != null ) {
					ISymbiot target = data.getTarget();
					retval = String.format("%,.4f", target.getFactor());
				}
				break;
			}
			return retval;
