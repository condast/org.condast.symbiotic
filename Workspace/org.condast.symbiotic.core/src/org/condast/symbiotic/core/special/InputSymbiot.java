 ...
 * @param <I>
 */
public abstract class InputSymbiot<I extends Object> extends Symbiot implements IInputSymbiot<I>{

	public static final String S_INPUT_SOURCE = "Input Source: ";
	
	private I input;
	
	protected InputSymbiot( String formId ) {
		this( formId, true);
	}

	protected InputSymbiot( String formId, boolean active) {
		super( formId, active);
		this.input = null;
